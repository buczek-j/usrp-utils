...
'''
Program to test different power configurations of the USRP nodes
'''
...
class UAV_Node():
    def __init__(self, my_config, l1_debug=False, l2_debug=False, l3_debug=False, l4_debug=False, l5_debug=False, dqn_config=None, alt=5, num_nodes=3, min_iteration_time=15.0, pow_index=3, node_index=0, log_base_name="~/Documents/usrp-utils/Logs/log_", csv_in=False, model_path='~/Documents/usrp-utils/saved_models/asym_scenarios_50container_loc/', encoded=False):
        '''
    ...
    def run(self):
        ...
        try:
            ...
            for setup_test in setups:
                for power in powers:
                    self.action_tx_gain(power)  # set the gain
                    ...
                    setup = "Iteration Number: " +str(iteration_num) +  ", l4_timeout:" + str(l4_timeout) + ", l2_timeout:" + str(l2_timeout) + ", l2_num: " + str(l2_num_retran) + ", TX power: " + str(power)
                    if self.layer4.log:
