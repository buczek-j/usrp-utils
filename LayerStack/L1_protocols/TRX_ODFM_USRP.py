...
class TRX_ODFM_USRP(gr.top_block):
    ...
    def __init__(self, input_port_num="55555", output_port_num="55556", rx_bw=0.5e6, rx_freq=2e9, rx_gain=0.8, serial_num="", tx_bw=0.5e6, tx_freq=1e9, tx_gain=0.8, l2_packet_size=255):
        ...
        self.digital_header_payload_demux_0 = digital.header_payload_demux(
            ...
            (),
            0)
        self.digital_crc32_bb_0_0 = digital.crc32_bb(False, length_tag_key, True)
