...
class tranceiver_ofdm_usrp_RS(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, input_port_num="55555", output_port_num="55556", rx_bw=0.5e6, rx_freq=2e9, rx_gain=0.8, serial_num="31C9237", tx_bw=0.5e6, tx_freq=2.0e9, tx_gain=1):
        ...
        self.setWindowTitle("tranceiver_ofdm_usrp_RS")
        ...
        self.settings = Qt.QSettings("GNU Radio", "tranceiver_ofdm_usrp_RS")
        ...
        self.connect((self.digital_crc32_bb_0_0, 0), (self.blocks_tagged_stream_multiply_length_0, 0))
