...
def ofdm_tranceiver_thread(stop, serial_num="31C9237", input_port_num="55555", output_port_num="55556", rx_bw=0.5e6, rx_freq=2e9, rx_gain=0.8, tx_bw=0.5e6, tx_freq=1e9, tx_gain=0.8):
    '''
    ...
    '''
    tb = TRX_ODFM_USRP(input_port_num=str(input_port_num), serial_num=str(serial_num), output_port_num=str(output_port_num), rx_bw=int(rx_bw), rx_freq=int(rx_freq), rx_gain=rx_gain, tx_bw=int(tx_bw), tx_freq=int(tx_freq), tx_gain=tx_gain)
