...
class Node_Config():
	def __init__(self, pc_ip='', usrp_ip='', my_id='src0', role='tx', listen_port=55557, usrp_ports=['55555', '55556'], rx_bw=500e3, rx_freq=2e9, rx_gain=0.95, tx_bw=500e3, tx_freq=2.1e9, tx_gain=0.8, serial="", location_index=0):
		'''
