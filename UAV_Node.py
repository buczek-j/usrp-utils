...
def main():
    ...
    dest1= Node_Config(pc_ip='192.168.10.106', usrp_ip='192.170.10.106', my_id='dest1', role='rx', tx_freq=freq3, rx_freq=freq2, serial="", tx_gain=tx_gain, rx_gain=rx_gain , location_index=10) 
    ...
    src1 = Node_Config(pc_ip='192.168.10.109', usrp_ip='192.170.10.109', my_id='src1' , role='tx', tx_freq=freq1, rx_freq=freq3, serial="", tx_gain=tx_gain, rx_gain=rx_gain ,location_index=0)
