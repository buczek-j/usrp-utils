...
def main():
    ...
    dest1= Node_Config(pc_ip='192.168.10.106', usrp_ip='192.170.10.106', my_id='dest1', role='rx', tx_freq=freq3, rx_freq=freq2, serial="", tx_gain=tx_gain, rx_gain=rx_gain , location_index=10) # TODO
