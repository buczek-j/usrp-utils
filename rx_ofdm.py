...
class rx_ofdm(gr.top_block):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0.set_bandwidth(band_width, 0)
        self.uhd_usrp_source_0.set_samp_rate(band_width)
    ...
    def set_band_width(self, band_width):
        ...
        self.uhd_usrp_source_0.set_samp_rate(self.band_width)
        self.uhd_usrp_source_0.set_bandwidth(self.band_width, 0)
